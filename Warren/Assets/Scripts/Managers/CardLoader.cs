...
public class CardLoader 
{
    ...
    Dictionary<(ModType, Stat), Action<PlayerStats, float>> statTable = new() // uses the mod type and stat as a key, returns a method
    {
        ...
        { (ModType.Weapon, Stat.DamageType), (p,v) => p.MeleeDamageTypes.Add(GetStatusEffect((int)v)) }, // adds damage type
        ...
        { (ModType.Spell, Stat.DamageType), (p,v) => p.SpellDamageTypes.Add(GetStatusEffect((int)v)) }, // adds damage type
        ...
        { (ModType.Player, Stat.DamageType), (p,v) => p.DamageResistances.Add(GetStatusEffect((int)v)) }, // adds damage type
    };
